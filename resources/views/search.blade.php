...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <form action="{{ route('form.index') }}" method="POST">
        ...
        <div class="row mb-4">
            ...
            <div class="col-sm-3">
                <input type="email" class="form-control form-control-sm  fs-6" id="colFormLabelSm" placeholder="" name="email" name="{{$searchemail}}">
            </div>
        </div>        
        ...
        <!-- <div class="d-grid gap-2 col-2 mx-auto mt-3 mb-5">
            <button type="submit" class="btn btn-dark">リセット</button>
        </div>  -->
        ...
        <div class="d-flex justify-content-start ">
            ...
            echo '全'. $posts_num. '件中'; 
            ?>
        {{ $posts->firstItem() }}-{{ $posts->lastItem() }}件
        </div>
            ...
            <table class="table align-middle">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>{{$post['opinion']}}</td>
                    <td>
                        <a href="/destroy/{{$posts['id']}}">
                            <form action="{{ route('form.destroy') }}"  method="POST">
                                @csrf
                                <input type="hidden" name="contact_id" value="{{ $posts['id']}}">
